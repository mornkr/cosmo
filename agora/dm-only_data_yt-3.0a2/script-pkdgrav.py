...
#  
#  PLEASE SEE:  https://hub.yt-project.org/nb/mp46a6
#
...
center = np.array([-0.0143, 0.0275, -0.0110]) # Tipsy unit system [-0.5, 0.5]
cosmology_parameters = dict(current_redshift = 0.0, omega_lambda = 0.728,
                            omega_matter = 0.272, hubble_constant = 0.702)

ds = TipsyStaticOutput("halo1e11_run1.00400", endian="<", field_dtypes = {"Coordinates": "d"},
...
pw.save("halo1e11_run1.00400_Projection_z_all_density_subset.png")
...
pw.save("halo1e11_run1.00400_Projection_z_finest_DM_density_subset.png")
